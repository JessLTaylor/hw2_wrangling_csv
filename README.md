...
```bash
cookiecutter gh:JessLTaylor/cookiecutter-datascience-simple
```
...
For the remote repository, make a github repository named hw2_wrangling_csv, then do;

```bash
git remote add origin git@github.com:JessLTaylor/hw2_wrangling_csv.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── hw2_wrangling_csv	<- Your notebooks and scripts will live in the main project folder
